...
description: "Effective communication patterns between AI systems and ROS 2 infrastructure"
sidebar_position: 5
...
Effective communication between AI systems and ROS 2 infrastructure is crucial for building responsive, efficient, and robust intelligent robotic applications. This section explores various communication patterns optimized for AI-ROS integration.

## High-Frequency Data Handling

### Publisher-Subscriber with Throttling

For high-frequency AI inference results that don't need every update:
...
class ThrottledAIPublisher(Node):
    ...
    def run_ai_inference(self, image):
        ...
        # In practice, this would run your AI model
        return f"Processed: {image.shape}"

    def publish_throttled_result(self):
        """Publish AI results at throttled rate"""
    ...
    def get_average_publish_rate(self):
        """Monitor actual publishing rate"""
        # Implementation for rate monitoring
        pass
...
For handling different types of AI results with different priorities:
...
class PriorityAIProcessor(Node):
    ...
    def process_queue_item(self, queue_obj, priority_level):
        ...
        try:
            ...
            # Use a timer to publish from main thread
    ...
    def process_ai_result(self, msg, priority_level):
        """Process AI result based on priority"""
...
class AIBasedController(Node):
    ...
    def control_loop(self):
        ...
        # Calculate AI-based control command
    ...
    def is_obstacle_ahead(self):
        """Check if there's an obstacle ahead using scan data"""
    ...
    def calculate_ai_control_command(self):
        ...
        # Get current robot angle (simplified - in practice use orientation)
        current_angle = 0.0  # Should use actual robot orientation
...
class BatchInferenceNode(Node):
    ...
    def load_model(self):
        """Load AI model for batch processing"""
        # In practice, load your actual model here
        # This is a placeholder
        return "dummy_model"

    def buffer_image(self, msg):
        """Add image to batch processing buffer"""
    ...
    def process_batch(self):
        """Process accumulated images in batch"""
        with self.buffer_lock:
            if len(self.input_buffer) == 0:
                return
    ...
    def prepare_batch(self, images):
        ...
        # This is simplified - implement based on your model requirements
        processed_images = []
        for img in images:
    ...
    def run_batch_inference(self, batch_tensor):
        ...
        # In practice, run your actual model inference
    ...
    def preprocess_image(self, image):
        ...
        # Implement preprocessing based on your model requirements
...
class AsyncAIProcessingNode(Node):
    ...
    async def process_image_async(self, image, header):
        """Asynchronously process image with AI model"""
        # Simulate async AI processing (e.g., API call, heavy computation)
        await asyncio.sleep(0.1)  # Simulate processing time

        # In practice, run your actual AI model here
        result = f"Processed async: {image.shape}"

        return result

    def async_processing_callback(self, msg):
        """Handle incoming image with async processing"""
        try:
            # Convert image
            cv_image = self.bridge.imgmsg_to_cv2(msg, desired_encoding='bgr8')
    ...
    def handle_async_result(self, future, header):
        """Handle result from async processing"""
        try:
...
class AIPerformanceMonitor(Node):
    ...
    def performance_callback(self, msg):
        ...
        # Record start time for this message
    ...
    def simulate_ai_processing(self, msg):
        """Simulate AI processing (replace with actual AI model)"""
        # In practice, run your actual AI model here
...
class OptimizedAICommunication:
    def __init__(self):
        # For real-time sensor data (can drop frames)
        ...
        # For important control commands (must be reliable)
        ...
        # For configuration parameters (need to persist)
...
class ResourceAwareAINode(Node):
    def __init__(self):
        ...
        # Monitor system resources and adjust AI processing accordingly
    ...
    def check_resources(self):
        ...
        if cpu_percent > self.cpu_threshold or memory_percent > self.memory_threshold:
            ...
            # Reduce processing rate or queue size
...
Effective AI-ROS communication patterns enable the development of responsive, efficient, and robust intelligent robotic systems that can handle real-time processing requirements while maintaining system stability and performance.